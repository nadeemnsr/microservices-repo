...
public class UsersController {
	 ...
	 * MediaType.APPLICATION_JSON_VALUE }) public ResponseEntity<UserResponseModel>
	 * getUser(@PathVariable String userId) {
	 * 
	 * UserDto dto = userService.getUserByUserId(userId); UserResponseModel
	 * returnValue =new ModelMapper().map(dto, UserResponseModel.class); return
	 * ResponseEntity.status(HttpStatus.CREATED).body(returnValue); }
	 */
}
